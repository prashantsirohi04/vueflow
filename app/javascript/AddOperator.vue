        ...
        <div class="modal-container">
          <div class="row">
            <div class="col-md-6" style="padding-right:0px;">
              <div class="img-container"><img src="./images/medical-record.svg" class="file-icon" style="width:50px;">
              </div>
              ...
              <div class='ui-basic'>
                <div class='content'>
                  ...
                  <div class='attached-buttons'>
                    <button class='cancel form-button bottom_btn' @click="close()">
                      CANCEL
                    </button>
                    <button class='delete form-button bottom_btn' v-on:click="close()">
                      DELETE
                    </button>
                    <button class='form-button bottom_btn save ' v-on:click="sendForm">
                        SAVE
                    </button>
                  </div>
                </div>
            ...
            <div class="col-md-6" style="padding-left:0px;">
              <div class="left-container">
                ...
                <div class="parameterWrap" style="width:100%">
                  <span class="imgTop">
                    <img src="./images/medical-record.svg" class="file-icon" style="width:30px;">
                    </span>
...
.save {
  background-color: #7bc5f7 !important;
